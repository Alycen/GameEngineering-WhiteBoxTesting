...
void SplashScene::Draw(sf::RenderWindow &win)
{
	...
	m_sprite.setPosition((win.getView().getSize().x / 2) + (m_texture.getSize().x / 13), (win.getView().getSize().x / 2) - (m_texture.getSize().y / 2)); // Need to make this scale more efficiently
