...
void SplashScene::Draw(sf::RenderWindow &win)
{
	...
	m_sprite.setPosition((win.getView().getSize().x / 2) + (m_texture.getSize().x / 25), (win.getView().getSize().x / 2) - (m_texture.getSize().y / 1.5)); // Need to make this scale more efficiently
